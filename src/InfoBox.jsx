...
export default function InfoBox({info}) {
    ...
    const RAIN_URL = "https://plus.unsplash.com/premium_photo-1670002344425-f274ee445f76?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
            ...
            <Card sx={{ maxWidth: 345 }}>
                ...
                <CardContent>
                    ...
                    <Typography variant="body2" sx={{ color: 'text.secondary' }} component="span" >
                        ...
                        <p>The weather can be described as <i style={{textDecoration: 'underline'}}>{info.weather}</i> and feels like {info.feelsLike}&deg;C</p>
                    </Typography>
                </CardContent>
            </Card>
            </div>
